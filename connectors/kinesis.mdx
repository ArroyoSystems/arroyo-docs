...
| source.poll_shard_interval_seconds | The number of seconds to wait between polling for new shards                     |  `10`            | `10`        |
...
Kinesis connector tables can be defined via SQL DDL and used as sources and sinks in SQL queries.
...
CREATE TABLE orders (
  ...
  'source.poll_shard_interval_seconds' = '10'
);
```
