...
StorageBackends, Arroyo's generalization of an object store, can now be passed additional arguments when instantiated.
...
Arroyo now supports partitioning of outputs. There are two types of partitioning: event time-based and field-based.
