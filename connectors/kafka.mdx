...
| source.read_mode | The read mode to use (either 'read_committed' or 'read_uncommitted') | If source | `read_committed` |
| sink.commit_mode | The commit mode to use (either 'exactly_once' or 'at_least_once') | If sink | `exactly_once` |
...
The Kafka sink supports both *exactly once* and *at least once*. 
