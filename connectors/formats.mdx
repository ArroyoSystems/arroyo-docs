...
[UDFs](/sql/udfs), this allows you to implement binary formats that are internal or otherwise
...
UDFs that operate on raw_bytes will take in an argument of type `&[u8]`, for example:
