...
Avro is well-supported by the Kafka ecosystem and the
[Confluent Schema Registry](https://docs.confluent.io/platform/current/schema-registry/index.html),
is a popular choice for storing and serving Avro schemas. Arroyo has deep support for the Schema Registry.
...
Avro data can be serialized/deserilaized in two ways:
...
to JSON, which can then be operated on using [SQL json functions](/sql/scalar-functions#json-functions) or UDFs.
