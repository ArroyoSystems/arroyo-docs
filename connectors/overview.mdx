...
| [Blackhole Sink](/connectors/blackhole) | No | Yes | OSS |
| [Impulse source](/connectors/impulse) | Yes | No | OSS |
| [Nexmark source](/connectors/nexmark) | Yes | No | OSS |
...
by the connetor. For example, Kafka stores data as a sequence of bytes, which can be
