...
In SQL, you can specify a connection profile via the `connection_profile` option in the `WITH` clause.
Additionally, SQL users can manually specify the various options via the WITH clause.
