...
and currently Arroyo supports _sliding_ and _tumbling_ windows.
...
## Sliding Windows
Sliding windows are similar to tumbling windows,
but the width of the window is different than how far it advances.
It is also referred to as a "hopping" window, because the window "hops" forward by some fixed slide.
