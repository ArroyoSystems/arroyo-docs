...
Once everything is running, you should be able to access the Arroyo UI. If you're running locally, you can use connect
directly to the pod with

```sh
$ open "http://$(kubectl get service/arroyo-api -o jsonpath='{.spec.clusterIP}')"
```

If you're running in EKS, you can proxy the service to your local machine with

```sh
$ kuebctl port-forward service/arroyo-api 8000:80 8001:8001
```
